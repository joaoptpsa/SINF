...
class Settlement {
    constructor({SettlementDiscount, SettlementAmount, SettlementDate, PaymentMechanism}){
...
class Invoice {
    ...
    constructor(XMLElement){
        ...
        this.documentTotals = [];
        for(const index in XMLElement.DocumentTotals){
            this.documentTotals.push(new DocumentTotal(XMLElement.DocumentTotals[index]));
        }
    }
}
