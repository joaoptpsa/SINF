...
class Customer {
    ...
    constructor(XMLElement){
        ...
        if (XMLElement.ShipToAddress) this.shipToAddress = XMLElement.ShipToAddress[0];
        ...
        if (XMLElement.SelfBillinIndicator) this.selfBillingIndicator = XMLElement.SelfBillingIndicator[0];
    }
}
